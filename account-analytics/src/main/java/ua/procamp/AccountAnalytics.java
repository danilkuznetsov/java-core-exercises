...
public class AccountAnalytics {
    ...
    public Map<String, List<Account>> groupAccountsByEmailDomain() {
        return accounts
                .stream()
                .collect(Collectors.groupingBy(account -> findEmailDomain(account.getEmail())));
    }

    private String findEmailDomain(String email) {
    ...
    public Map<String, Set<String>> groupFirstNamesByLastNames() {
        return accounts
                .stream()
                .collect(
                        Collectors.groupingBy(Account::getLastName,
